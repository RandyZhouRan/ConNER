...
def preprocess(sentence):
    ...
    for w in sentence:
        ...
        if s !="":
            ...
            l = len(w2)
            if l == 1:
                v = "S-"+ner+str(n-1)+" "+w2[0]
            elif l > 1:
                for i in range(l):
                    if i == 0:
                        v = "B-"+ner+str(n-1)+" "+w2[i]
                    elif i == l-1:
                        v = v+" "+"E-"+ner+str(n-1)+" "+w2[i]
                    else:
                        v = v+" "+"I-"+ner+str(n-1)+" "+w2[i]
            values = []
            values.append(v)
    ...
    with open(fpath, 'r') as inf, open(ofpath, 'w') as of:
        for line in inf:
            ...
            if line != '':
                ...
                #print("sentence_preprocessed", sentence_preprocessed)
                #print("dict1", dict1)
