...
def build_args(parser):
    """Build arguments."""
    parser.add_argument("--inp_file", type=str, default='en.full.txt')
    parser.add_argument("--out_file", type=str, default='en.trans.iobes.txt')
...
def main():
    ...
    print(f"Read from {args.inp_file}: {len(data)}")
    ...
    print(f"Write to {args.out_file}: {success}")
