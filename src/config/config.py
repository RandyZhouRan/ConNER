...
class Config:
    def __init__(self, args) -> None:
        ...
        self.test_file_en = "../../data/" + self.dataset + "/test_en.txt"
        self.test_file_de = "../../data/" + self.dataset + "/test_de.txt" 
        self.test_file_es = "../../data/" + self.dataset + "/test_es.txt"
        self.test_file_nl = "../../data/" + self.dataset + "/test_nl.txt"
        self.test_file = "../../data/" + self.dataset + "/test.txt"
        self.test_file_id = "../../data/" + self.dataset + "/test_id.txt"
        self.test_file_target = "../../data/" + self.dataset + "/test_target.txt"
        self.unlabel_file = "../../data/" + self.dataset + "/unlabel.txt"
        self.trans_file = "../../data/" + self.dataset + "/trans.txt"
        
        self.train_num = args.train_num
        self.dev_num = args.dev_num
        self.test_num = args.test_num
        self.uda_num = args.uda_num if "uda_num" in args.__dict__ else None
        ...
        self.uda_threshold = args.uda_threshold if "uda_threshold" in args.__dict__ else None
        self.uda_weight = args.uda_weight if "uda_weight" in args.__dict__ else None
        self.uda_config = args.uda_config if "uda_config" in args.__dict__ else None
        self.rdrop_weight = args.rdrop_weight if "rdrop_weight" in args.__dict__ else None
