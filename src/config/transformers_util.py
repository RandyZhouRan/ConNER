...
context_models = {
    ...
    'xlm-roberta-large': {"model": XLMRobertaModel, "tokenizer": XLMRobertaTokenizer},
    'bert-base-multilingual-uncased' : {  "model": BertModel,  "tokenizer" : BertTokenizer },
    'bert-base-multilingual-cased' : {  "model": BertModel,  "tokenizer" : BertTokenizer },
}
